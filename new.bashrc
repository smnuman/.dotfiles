...
#  Set a background. Also there is a DeepBackground($DBG) set according to the user above!
BG=${On_Black}
CNX=$CNX"${BG}"
SU=$SU"${BG}"
AT=${BCyan}"${BG}"
...
#        PS1="${PS1}\[${SU}\]\u\[${NC}\]@\[${CNX}\]\h\[${NC}\] "
        PS1="${PS1}\[${SU}\]\u\[${AT}\]@\[${CNX}\]\h \[${NC}\]"
        # PWD (with 'disk space' info):
#        PS1="${PS1}\[\$(disk_color)\]\W]\[${NC}\] "
        PS1="${PS1}\[\$(disk_color)${DBG}\]| \w \[${NC}\] "
        # Prompt (with 'job' info):
        # PS1="${PS1}\[\$(job_color)\]>\[${NC}\] "
        PS1="${PS1}\[${NC}\$(job_color)\]\$\[${NC}\] "
